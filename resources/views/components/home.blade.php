...
<section x-data="{ activeTab: 'dashboard', sidebarOpen: false, leadFormOpen: false }" class="bg-white min-h-screen flex">
    ...
    <main class="flex-1 p-6 lg:ml-0 h-screen overflow-y-auto">
        ...
        <div x-show="activeTab === 'addclient'" x-cloak><x-leads.add-clients /></div>
        ...
        <!-- Now this will open -->
        <div x-show="activeTab === 'leadindustry'" x-cloak><x-leads.LeadIndustry /></div>
        <div x-show="activeTab === 'leadrating'" x-cloak><x-leads.LeadRating /></div>
        <div x-show="activeTab === 'leadsource'" x-cloak><x-leads.LeadSource /></div>
        <div x-show="activeTab === 'leadaddress'" x-cloak><x-leads.LeadAddress /></div>
