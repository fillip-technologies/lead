<main class="flex-1 w-full">
    ...
    <div class="p-6">
        <div class="mx-auto">
            <div class="mb-6">
                <h2 class="text-3xl font-bold text-foreground mb-2">Add New Lead Industry</h2>
                <p class="text-muted-foreground">Fill in the Lead Industry details</p>
            </div>
            <div class="rounded-lg border bg-white text-card-foreground shadow-sm">
                <div class="flex flex-col space-y-1.5 p-6">
                    <h3 class="text-2xl font-semibold leading-none tracking-tight">Lead Industry Information</h3>
                    <p class="text-sm text-muted-foreground">Enter the new lead industry</p>
                </div>
                <div class="p-6 pt-0">
                    <form class="space-y-6">
                        ...
                        <div class="space-y-2">
                            <label
                                ...
                                for="name">Lead Industry Name *</label>
                            <input
                        ...
                        <button
                            ...
                            type="submit">Add Lead Industry</button>
                    </form>
                </div>
            </div>
        </div>
