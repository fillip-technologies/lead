<main class="flex-1 w-full">
    <div class="p-6">
        <div class="space-y-6">
            <!-- Header -->
            <div>
                <h2 class="text-3xl font-bold text-foreground mb-2">Digital Marketing Campaign</h2>
        ...
        <section class="py-6">
            <div class="overflow-x-auto">
                <table class="w-full text-sm border rounded-lg border-gray-300 border-collapse">
                    ...
                    <tbody>
                        @foreach ($digitalmarketing as $data)
                            <tr class="border-b border-gray-300 transition">
                                ...
                                <td class="px-4 py-3 font-medium capitalize">
                                    <a href="{{ route('digitalmarketing.show', $data->id) }}"
                    ...
                    @if (empty($digitalmarketing) || count($digitalmarketing) === 0)
