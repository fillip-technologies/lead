<main class="flex-1 w-full">
    <div class="p-6">
        <div class="space-y-6">
            <!-- Header -->
            <div>
                <h2 class="text-3xl font-bold text-foreground mb-2">Website Campaign</h2>
                        ...
                        @foreach ($website as $data)
                            <tr class="border-b border-gray-300 transition">
                                ...
                                <td class="px-4 py-3 font-medium capitalize">
                                    <a href="{{ route('websitedesign.show', $data->id) }}"
                                ...
                                <td class="px-4 py-3 text-gray-700">{{ $data->message }}</td>
